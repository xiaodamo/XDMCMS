...
//===========================图片预览================================
    function setImagePreview(oid) {
        var docObj=document.getElementById("FileUpload_"+oid);

        var imgObjPreview=document.getElementById("preview_"+oid);
        ...
        else
        {
            ...
            var localImagId = document.getElementById("localImag_"+oid);
            //必须设置初始大小
