...
<article class="blogs">
    <h1 class="t_nav"><span>小达摩笔记，记录生活点滴，总有一些美好的事物值得回忆。</span><a href="/" class="n1">网站首页</a><?php if($type == "tags"):?><a href="/tags/<?php echo $info['id']?>/" class="n2"><?php echo $info['name']?></a><?php else:?><a href="javacript:void(0)" class="n2">搜索</a><?php endif;?></h1>
