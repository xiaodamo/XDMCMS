<?php $this->load->view('_header');?>
            <div class="mvctool">
                ...
                <a id="btnReply" style="float: left;" class="l-btn l-btn-plain"><span class="l-btn-left"><span class="l-btn-text fa fa-weixin" style="font-size:14px"></span><span style="font-size:12px">回复</span></span></a><div class="datagrid-btn-separator"></div>
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    $('#List').datagrid({
                        url: '/admin/contact/index/method/json',
                        ...
                        columns: [[
                            ...
                            { field: 'name', title: '昵称', width: 55 },
                            { field: 'icon', title: '头像', width: 55 },
                            { field: 'email', title: '邮箱', width: 55 },
                            { field: 'url', title: '站点', width: 55 },
                            { field: 'content', title: '内容', width: 55 },
                            { field: 'reply', title: '回复', width: 55 },
            ...
            <script type="text/javascript">
                ...
                $(function () {
                    $("#btnCreate").click(function () {
                        $("#modalwindow").html("<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='/admin/contact/add'></iframe>");
                    ...
                    $("#btnEdit").click(function () {
                        ...
                        if (row != null) {
                            ...
                            $("#modalwindow").html("<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='/admin/contact/edit/id/" + row.id+"'></iframe>");
                    ...
                    $("#btnReply").click(function () {
                        ...
                        if (row != null) {
                            ...
                            $("#modalwindow").html("<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='/admin/contact/replyto/id/" + row.id+"'></iframe>");
                            $("#modalwindow").window({ title: "回复"+row.name+"的基本信息", width: 730, height: 500, iconCls: 'fa fa-edit',closed:true,minimizable:false,shadow:false }).window('open');
                    ...
                    $("#btnDelete").click(function () {
                        ...
                        if (row != null) {
                            $.messager.confirm('删除确认', '是否删除此数据', function (r) {
                                if (r) {
                                    $.post("/admin/contact/delete/id/" + row.id, function (data) {
                                        if (data.status == 1)
                                            $("#List").datagrid('reload');
