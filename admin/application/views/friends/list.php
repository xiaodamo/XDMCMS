<?php $this->load->view('_header');?>
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    $('#List').datagrid({
                        url: '/admin/friends/index/method/json',
                        ...
                        columns: [[
                            ...
                            { field: 'name', title: '友情链接名', width: 55 },
                            { field: 'link', title: '链接', width: 55 },
            ...
            <script type="text/javascript">
                ...
                $(function () {
                    $("#btnCreate").click(function () {
                        $("#modalwindow").html("<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='/admin/friends/add'></iframe>");
                    ...
                    $("#btnEdit").click(function () {
                        ...
                        if (row != null) {
                            ...
                            $("#modalwindow").html("<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='/admin/friends/edit/id/" + row.id+"'></iframe>");
                    ...
                    $("#btnDelete").click(function () {
                        ...
                        if (row != null) {
                            $.messager.confirm('删除确认', '是否删除此数据', function (r) {
                                if (r) {
                                    $.post("/admin/friends/delete/id/" + row.id, function (data) {
                                        if (data.status == 1)
                                            $("#List").datagrid('reload');
